...
export declare function nextTick(cb: (...args: any[]) => void): Promise<void>;
...
export declare function groupSetData(context: WechatMiniprogram.Component.TrivialInstance, cb: () => void): Promise<void>;
...
export declare const isPC: () => Promise<boolean>;
export declare const isWxWork: () => Promise<boolean>;
